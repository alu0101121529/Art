...
public class elementos_ficheros {
	...
	public elementos_ficheros(String fichero_caminos, String fichero_heuristicas) {
		...
		try {
			...
			fichero_h = fichero_heuristicas; // Ponemos el nombre del fichero de heurísticas en el atributo que creamos
			...
			fichero_c = fichero_caminos; // Ponemos el nombre del fichero de caminos en el atributo que creamos
			...
			archivo = new File(fichero_caminos); 
			...
			if (linea != null) {
				...
				br.close();
				fr.close();
				archivo = new File(fichero_heuristicas);
				fr = new FileReader(archivo);
				br = new BufferedReader(fr);
